            ...
            <div className="relative z-10 flex flex-col items-center justify-center text-center text-gray-800 mt-[100vh] mx-3">
              ...
              >
                ...
                <motion.img
                  ...
                  loading="lazy"
                  alt="Bunga Pembuka"
                  className=" w-[200px] mx-auto border-4 border-[#463dc6] mb-5 h-[200px] object-cover rounded-4xl"
                />
                      ...
                      {dataMempelai?.rekening.length > 0
                        ? dataMempelai?.rekening.map((rek, index) => (
                            <motion.div
                              ...
                              className="bg-white/95 shadow-xl rounded-2xl mx-auto mb-5 px-8 py-6 w-80 text-left border border-teal-100 relative overflow-hidden"
                            >
                              <img
